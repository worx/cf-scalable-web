...
\begin{itemize}[nosep]
  ...
  \item \textbf{Cost expectation}: closer to \$25/mo than \$15/mo at the projected 20K/month volume (Zac's reports have many pages; more pages = longer execution = more billed compute).
